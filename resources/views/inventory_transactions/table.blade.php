...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#typeStock option').click(function(){
                alert();
                ShowLoad();
            })
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="infoModelLabel">{{ __('inventory_transactions.select_a_date_range') }}</h5>
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-sm-12">
                <label for="datefrommodel">{{ __('inventory_transactions.date') }}:</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="dateRange();">{{ __('inventory_transactions.search') }}</button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('inventory_transactions.close') }}</button>
        </div>
      </div>
    </div>
</div>