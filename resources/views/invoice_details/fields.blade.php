...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('invoice_id', $invoiceItems, null, ['class' => 'form-control select2', 'placeholder' => 'Pick a Invoice...', 'autofocus', 'id' => 'invoice_id']) !!}
</div>
        ...
        $(document).ready(function () {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response && response.length > 0) {
                                ...
                                batchSelect.append('<option value="">{{ __("No batches available") }}</option>');
                                $('#batch_selection_group').show();
            ...
            function getprice(){
                ...
                if(invoice_id != '' && product_id != ''){
                    ...
                    var url = '{{ config("app.url") }}/invoice-price/'+invoice_id+'/'+product_id;
