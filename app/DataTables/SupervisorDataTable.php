...
class SupervisorDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'ic'=> new \Yajra\DataTables\Html\Column(['title' => trans('operations.ic'),
            'data' => 'ic',
            'name' => 'supervisors.ic']),

            'phone'=> new \Yajra\DataTables\Html\Column(['title' => trans('operations.phone'),
            'data' => 'phone',
            'name' => 'supervisors.phone']),
